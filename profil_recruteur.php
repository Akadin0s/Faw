...
$sql2 = "SELECT * FROM `offres_postules`,`offres` where offres.Id_offre = offres_postules.id_offre
AND offres_postules.id_recruteur = '$idrec';";
$sth2 = $cnx->query($sql2);
$accoffres = $sth2->fetchAll();

$sql3 = "SELECT DISTINCT *  FROM `candidats`, `offres_postules` where candidats.id_cand = offres_postules.id_candidat;";
$sth3 = $cnx->query($sql3);
$name = $sth3->fetch();
?>
