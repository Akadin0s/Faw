...
$sql2 = "SELECT DISTINCT * FROM `offres`,`offres_postules` where offres.Id_offre = offres_postules.id_offre
        ...
        <div id="candidat" class="candidat" style="display:block;">
            ...
            <?php foreach($result2 as $row){
                ...
                echo"<div class=cd_offre>
                    ...
                    <a href='includes/deletePostulation.php?refuser=".$row['Id_offre']."><button name='refuser' id='refuser'>Supprimer</button></a>
                </div>";}}?>
